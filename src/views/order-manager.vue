               ...
               <div class="pad-b-20 clearfix">
                 <div class="pull-left">
                   <Form :model="formTop" inline class="circle-input">
                     ...
                     <FormItem label="" >
                       <Input style="width: 200px"  placeholder="请输入订单编号"></Input>
                     </FormItem>
                 ...
                 <div class="pull-right drop-down-wrap">
                     ...
                     <div class="drop-down" :class="[hide, visualHidden]">
                       ...
                       <Form :model="formTop" :label-width="100">
                         <FormItem label="下单时间" >
                           <DatePicker type="datetimerange" style="width: 100%" placement="bottom-end" placeholder="选择日期和时间"></DatePicker>
                         </FormItem>
                         <FormItem label="收货人信息" >
                           <Input placeholder="请输入收货人/收货电话" ></Input>
                         </FormItem>
                         <FormItem label="商品信息" >
